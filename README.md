...
Our short term goal is to implement the functionlities of a WoT Consumer, i.e. the functionlities needed to fetch a TD and consume it to interact with the entity it describes.
